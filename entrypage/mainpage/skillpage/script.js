...
const planetTexture = new
THREE.TextureLoader().load('https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Solarsystemscope_texture_8k_jupiter.jpg/1600px-Solarsystemscope_texture_8k_jupiter.jpg?20201026210228');
...
window.addEventListener("click", (event) => {
  ...
  const textArray = ["HTML5", "CSS2 & CSS3", "JavaScript ES5 & ES6", "Tailwind CSS", "PHP","Ajax Technology", "MySQL", "GSAP","THREE.JS", "GSAP Plugin","Python","C++","Java","c","DSA","React","Express.JS","Node.JS"];
  let textIndex = 0;
