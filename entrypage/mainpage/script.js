...
// ✅ Three.js Library Import (3D Graphics ke liye)
  ...
  gsap.to(".text-show", {
    ...
    onComplete: function () {
      ...
      gsap.timeline({ repeat: -1, yoyo: true, defaults: { duration: 2, ease: "power2.out" } })
      .from(".bg-layer .close", { y: "-200px" });
  ...
  gsap.to([".black-hole .top", ".black-hole .bottom"], {
    ...
    onComplete: function () {
      ...
      gsap.to(".curr p", { text: "Software Engineer | Web Developer", duration: 2, ease: "power2.out" });
